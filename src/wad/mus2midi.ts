...
export function mus2midi(musinput: ArrayBuffer) {
    ...
    */
    ...
    function convertMusToMidi(musinput: ArrayBuffer) {
        ...
        // Check MUS header
        if (
            musfileheader.id[0] != "M".charCodeAt(0) ||
            musfileheader.id[1] != "U".charCodeAt(0) ||
            musfileheader.id[2] != "S".charCodeAt(0) ||
                ...
                switch (mus_event) {
                    ...
                    case mus_systemevent:
                        ...
                        if (controllernumber < 10 || controllernumber > 14) {
                            console.log(
                                "controller number inaccurate 10-14:" +
                                    controllernumber
                            );
                            return false;
                        }
                    ...
                    case mus_changecontroller:
                        ...
                        if (controllernumber == 0) {
                            ...
                            if (controllernumber < 1 || controllernumber > 9) {
                                console.log(
                                    "controller number inaccurate: " +
                                        controllernumber
                                );
                                return false;
                            }

                            writeChangeController_Valued(
                                channel,
                                controller_map[controllernumber],
                                controllervalue
                            );

		...
		uglify: {
			build: {
				...
				files: {
					...
					'dist/ui.min.js': ['src/panels/wad_overview.js', 'src/panels/lump_list.js', 'src/panels/audio.js', 'src/panels/text.js', 'src/panels/image.js', 'src/panels/midi.js', 'src/ui.js']
				}
			}
		}
	});
